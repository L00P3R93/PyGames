"""
Interface class for stockfish chess engine.
This is used in the singleplayer mode.
"""
...
class StockFish:
    def __init__(self, path="stockfish", level=1):
        ...
        try:
            self.stockfish = subprocess.Popen(path, universal_newlines=True, stdin=subprocess.PIPE,
